...
[Circular barplot with R and ggplot2](https://r-graph-gallery.com/web-circular-barplot-with-R-and-ggplot2.html)

# Added Links

[How can I handle R CMD check "no visible binding for global variable" notes when my ggplot2 syntax is sensible?](https://stackoverflow.com/questions/9439256/how-can-i-handle-r-cmd-check-no-visible-binding-for-global-variable-notes-when)
